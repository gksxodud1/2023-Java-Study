package Map;
    ...
    public class HashMap {
        public static void main(String[] args) {
            ...
            list.add(???);//Map을 list 에 담기
            list.add(???);// Map을 list 에 담기

            java.util.HashMap<String,String> takeMap1 = (java.util.HashMap<String, String>) list.???(?);  //첫번째 칸 리스트에 담기
            String name1 = takeMap1.get("이름");
            String age1 = takeMap1.get("나이");
            String job1 = takeMap1.get("직업");

            java.util.HashMap<String,String> takeMap2 = (java.util.HashMap<String, String>) list.???.(?);  //두번째 칸 리스트에 담기
